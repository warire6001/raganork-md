...
module.exports = {
    VERSION: 'V1.0.2',
    ALIVE: process.env.ALIVE || "https://i.imgur.com/u303PHN.jpg Hey {sender}, Hey! Aktifim! Laçin Eke YouTube \n Uptime: {uptime}",
    ...
    BOT_INFO: process.env.BOT_INFO || 'https://i.imgur.com/u303PHN.jpg',
